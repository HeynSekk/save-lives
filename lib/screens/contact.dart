                    ...
                    Wrap(
                      ...
                      children: <Widget>[
                        ...
                        InkWell(
                          ...
                          child: linkImg(context, 'assets/images/chokAd.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/chokBaby.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/chokChi.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/cprAd.jpg'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/cprBaby.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/cprChild.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/drowning.jpg'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                        ...
                        InkWell(
                          ...
                          child: linkImg(context, 'assets/images/faint.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/heaAtt.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/heaInj.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/natural.jpg'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/priSurAd.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/priSurBa.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/recPosAd.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/recPosBa.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/seiAd.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/seiBa.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/seiChi.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/sevBl.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                          ...
                          child: linkImg(context, 'assets/images/sevBlBa.png'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
                        ...
                        InkWell(
                          ...
                          child: linkImg(context, 'assets/images/tornado.jpg'),
                        ),
                        InkWell(
                          onTap: () => setState(() {
                            _launched = _launchInBrowser(
